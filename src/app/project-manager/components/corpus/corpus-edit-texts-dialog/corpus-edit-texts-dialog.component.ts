...
@Component({
  selector: 'pm-corpus-edit-texts-dialog',
  templateUrl: './corpus-edit-texts-dialog.component.html',
  styleUrls: [
    '../../base-import-other-dialog.scss',
    '../../base-crud-dialog.scss',
  ],
})
export class CorpusEditTextsDialogComponent {
  ...
  onSave(): void {
    ...
    this.addedCorpora?.forEach((corpus) => {
      this.corpusService
        .copyTextsFrom(this.data.id, corpus.id!)
        .subscribe(() => {
