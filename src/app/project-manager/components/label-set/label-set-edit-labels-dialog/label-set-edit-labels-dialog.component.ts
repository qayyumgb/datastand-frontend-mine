...
@Component({
  selector: 'pm-label-set-edit-labels-dialog',
  templateUrl: './label-set-edit-labels-dialog.component.html',
  styleUrls: [
    '../../base-import-other-dialog.scss',
    '../../base-crud-dialog.scss',
  ],
})
export class LabelSetEditLabelsDialogComponent {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<LabelSetEditLabelsDialogComponent>,
